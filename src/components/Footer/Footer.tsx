...
export default function Footer () {
  return (
    <div className="w-full bg-white grid grid-cols-5 h-screen/5">
      <div className="flex flex-col pt-9">
        <div className="w-full p-4 flex justify-center"><img src={LogoDarkWords} alt="Logo" style={{maxWidth:150}}/></div>
      ...
      <div className="flex flex-col pt-12">
        ...
        <a href="#" className="hover:underline">Inspo</a>
      </div>
      <div className="flex flex-col pt-12">
